...
<script>
    ...
    import {login, sendsms} from "@/apis/user";
    import {setId, setToken, setPhone, getId, getToken, removeUserInfo} from "@/utils/user";
    ...
    export default {
        ...
        mounted() {
            ...
            this.$route.query.token? this.tokenLogin(): this.directLogin = false;
        ...
        methods: {
            wxShareFn() {
                ...
                let shareParams = {
                    title: '想进行一次专属的心灵探索之旅吗？',
                    desc: '全方位心理评估',
                    imgUrl: 'https://file.shangjinuu.com/content/imgs/jh_share_icon.png',
                    link: window.location.protocol+'//'+window.location.host+'/scale-h5server/examV2/index.html#/login?examId='+this.$route.query.examId,
                };
                if(isWeiXin){
